...
"""
================================================================================
CATALYST SCORER v32.1.0 — Re-score 2026 Catalysts with Gungnir v32.1
================================================================================
Loads v32.1 deploy JSON (92 features: v31.1 + sponsor_success_rate + indication_density).
Computes historical sponsor track record and indication density from training data.

USAGE:
  python catalyst_scorer_v32.py
"""
...
OUTPUT_JSON = os.path.join(DATA_DIR, "catalyst_scores_v32.json")
...
def main():
    print("=" * 80)
    print("CATALYST SCORER v32.1.0 — 2026 Investment Engine (Leakage-Clean)")
    print("=" * 80)
    ...
    # Score all events
    print(f"\n[SCORE] Scoring {len(events)} catalysts with Gungnir v32.1...")
    scored = []
    for event in events:
    ...
    print(f"\n{'='*80}")
    print("v32.1 INVESTMENT TIER SUMMARY")
    print(f"{'='*80}")
