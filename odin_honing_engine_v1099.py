...
DEFAULT_ANCHOR  = "odin_v1099_anchor.json"
...
OUTPUT_HONED    = "odin_v1099_honed.json"
OUTPUT_ENSEMBLE = "odin_v1099_honed_ensemble.json"
...
def build_feature_vector(r) -> list:
    """Map one CSV row → 48-element feature vector matching FEATURE_NAMES."""
...
def main():
    parser = argparse.ArgumentParser(description="ODIN Honing Engine v4.8")
    ...
    print(f"""
╔══════════════════════════════════════════════════════════════╗
║  ODIN HONING ENGINE v4.8                                    ║
║  CRS-Primary + Platt Calibration + Decoupled Hint Features  ║
╠══════════════════════════════════════════════════════════════╣
