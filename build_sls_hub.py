...
(vesting on the deal alone) is the structure that rewards simply completing a sale; double-trigger is the
structure proxy advisors and compensation committees treat as governance best practice, and it is what SELLAS adopted.
</div>
<div class="myth">
...
<div class="f">What the document says</div>The CFO/CDO change-of-control cash benefit is <b>15 months of base salary</b>
(1.25&times;) plus target bonus. Multiples in that range sit at the modest end for biotech change-of-control
arrangements, where 2&times;&ndash;3&times; salary-plus-bonus is common for senior executives.
</div>
<div class="myth">
