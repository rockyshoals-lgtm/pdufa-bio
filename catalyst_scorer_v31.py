...
"""
================================================================================
CATALYST SCORER v31.1.0 — Re-score 2026 Catalysts with Gungnir v31.1
================================================================================
Loads v31.1 deploy JSON, uses v31 feature engineering (T-1 clean), scores all
848 catalysts, produces investment tiers + EV estimates.

USAGE:
  python catalyst_scorer_v31.py              # Full run (uses cached CT.gov)
  python catalyst_scorer_v31.py --refresh    # Re-fetch CT.gov data
"""
...
DEPLOY_JSON = os.path.join(DATA_DIR, "gungnir_v31_deploy.json")
...
OUTPUT_JSON = os.path.join(DATA_DIR, "catalyst_scores_v31.json")
...
# =============================================================================
# GUNGNIR v31.1 SCORING ENGINE
# =============================================================================

class GungnirV31:
    """Self-contained v31.1 scoring engine loaded from deploy JSON."""

    def __init__(self, deploy_path=DEPLOY_JSON):
    ...
    def score(self, feature_dict):
        ...
        # Meta-ensemble: 70% Ridge + 30% ElasticNet
...
def main():
    print("=" * 80)
    print("CATALYST SCORER v31.1.0 — 2026 Investment Engine (Leakage-Clean)")
    print("=" * 80)

    # Load Gungnir v31.1
    gungnir = GungnirV31()
    print(f"\n[ENGINE] Gungnir v{gungnir.version} loaded ({gungnir.n_features} features)")
    ...
    # Score all events
    print(f"\n[SCORE] Scoring {len(events)} catalysts with Gungnir v31.1...")
    scored = []
    for event in events:
    ...
    print(f"\n{'='*80}")
    print("v31.1 INVESTMENT TIER SUMMARY")
    print(f"{'='*80}")
