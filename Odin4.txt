"""
ODIN v10.66 "DYNAMIC GRANDMASTER" (Fine-Tuning Phase)
=====================================================
GOAL:    Refine parameters starting from 'odin_v1066_expanded_best.json'.
CHANGES: Tighter search radius (8% -> 0.1%) for precision optimization.
"""
...
# UPDATED: Load the file you just uploaded
PREVIOUS_BEST_FILE = "odin_v1066_expanded_best.json"

# UPDATED: Save to a new final file
OUTPUT_FILE = "odin_v1066_grandmaster_final.json"

TRAIN_SPLIT_PCT = 0.70

# UPDATED: Tighter radius for fine-tuning
START_RADIUS = 0.08     # Start at 8% variance (was 15%)
END_RADIUS = 0.001      # End at 0.1% variance (was 0.5%)
...
class OdinGrandmasterEngine:
    ...
    def _build_matrices(self, df):
        ...
        # MAPPING CHECK: Ensure these indices align with your JSON key order!
...
def main():
    print("[ODIN] DYNAMIC RAM Search (Fine-Tuning Mode)...")
    ...
    print(f"BASELINE (Current Best): Train={best_tr_b:.5f} | Test={best_te_b:.5f}")
