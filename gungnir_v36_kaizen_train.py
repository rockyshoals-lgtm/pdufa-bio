...
DEPLOY_JSON = os.path.join(DATA_DIR, "gungnir_v36_kaizen_deploy.json")
...
def main():
    ...
    for split_name, test_start, test_end in splits:
        ...
        m1 = LogisticRegression(C=0.5, penalty="l2", solver="lbfgs", max_iter=2000)
        m1.fit(X_tr, y_train)
    ...
    m1_final = LogisticRegression(C=0.5, penalty="l2", solver="lbfgs", max_iter=2000)
    ...
    XGB_PATH = os.path.join(DATA_DIR, "gungnir_v36_kaizen_xgb.json")
    ...
    deploy = {
        ...
        "xgb_model_path": "gungnir_v36_kaizen_xgb.json",
