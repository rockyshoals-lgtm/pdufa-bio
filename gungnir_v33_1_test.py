...
"""
================================================================================
GUNGNIR v33.0.0 — ALLFATHER ASCENDANT PHASE READOUT PREDICTION ENGINE
================================================================================
...
DEPLOY_JSON = os.path.join(DATA_DIR, "gungnir_v33_1_ablation_deploy.json")
...
def engineer_v31_features(row, ctgov_lookup=None, journey_index=None):
    ...
    if momentum and "error" not in momentum and momentum.get("d_m1"):
        ...
        # v33.1 ABLATION: removed momentum_10d, volatility_5d, momentum_x_micro, momentum_x_phase3
    ...
    # v33.1 ABLATION: removed competitive_6mo (negative coef), kept competitive_3mo
    features["competitive_3mo"] = min(comp.get("n_3mo", 0), 10)

    # --- v33 NEW INTERACTIONS (ABLATION: removed harmful ones) ---
    features["competitive_x_onc"] = features["competitive_3mo"] * features["ta_oncology"]
...
def main():
    ...
    print("=" * 80)
    print("GUNGNIR v33.0.0 — ALLFATHER ASCENDANT TRAINING PIPELINE")
    print("=" * 80)
    if not HAS_XGB:
    ...
    XGB_PATH = os.path.join(DATA_DIR, "gungnir_v33_xgb.json")
    ...
    deploy = {
        ...
        "xgb_model_path": "gungnir_v33_xgb.json",
    ...
    print(f"\n{'='*80}")
    print(f"GUNGNIR v33.0.0 TRAINING COMPLETE")
    print(f"{'='*80}")
