...
"""
================================================================================
CATALYST SCORER v33.0.0 — Re-score 2026 Catalysts with Gungnir v33
================================================================================
Loads v33 deploy JSON (103 features: v32.1 + momentum + competitive + XGBoost).
5-model meta-ensemble: Ridge 50% + ElasticNet 20% + XGBoost 30%.

USAGE:
  python catalyst_scorer_v33.py
"""
...
XGB_MODEL_PATH = os.path.join(DATA_DIR, "gungnir_v33_xgb.json")
...
OUTPUT_JSON = os.path.join(DATA_DIR, "catalyst_scores_v33.json")
...
# =============================================================================
# GUNGNIR v33 SCORING ENGINE
# =============================================================================

class GungnirV33:
    """Self-contained v33 scoring engine with XGBoost support."""
...
def main():
    print("=" * 80)
    print("CATALYST SCORER v33.0.0 + IIS v1.0 — 2026 Investment Engine")
    print("=" * 80)
    ...
    # Score all events
    print(f"\n[SCORE] Scoring {len(events)} catalysts with Gungnir v33 + IIS overlay...")
    scored = []
    iis_flagged = 0
    for event in events:
    ...
    print(f"\n{'='*80}")
    print("v33.0 INVESTMENT TIER SUMMARY")
    print(f"{'='*80}")
