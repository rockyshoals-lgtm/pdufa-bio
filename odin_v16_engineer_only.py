...
# ========== v18 HOOK: save engineered frames for downstream kaizen ==========
import pickle
pickle.dump({
    'df_train_e': df_train_e, 'df_val_e': df_val_e, 'df_test_e': df_test_e,
    'v14_features': v14_features, 'candidate_features': candidate_features,
    'cutoff_train': cutoff_train, 'cutoff_val': cutoff_val,
}, open(f'{BASE}/odin_v16_engineered_frames.pkl','wb'))
print("SAVED: odin_v16_engineered_frames.pkl")
# Exit early — don't run full rebuild stages 1-3
raise SystemExit(0)
# ============================================================================
